...
.method public constructor <init>(IILandroid/support/constraint/motion/KeyPosition;Landroid/support/constraint/motion/MotionPaths;Landroid/support/constraint/motion/MotionPaths;)V
    ...
    .param p3, "c"    # Landroid/support/constraint/motion/KeyPosition;
    .param p4, "startTimePoint"    # Landroid/support/constraint/motion/MotionPaths;
    .param p5, "endTimePoint"    # Landroid/support/constraint/motion/MotionPaths;
...
.method public applyParameters(Landroid/support/constraint/ConstraintSet$Constraint;)V
    ...
    .line 681
    .local v0, "point":Landroid/support/constraint/motion/MotionPaths;
    iget-object v1, p1, Landroid/support/constraint/ConstraintSet$Constraint;->motion:Landroid/support/constraint/ConstraintSet$Motion;

    iget-object v1, v1, Landroid/support/constraint/ConstraintSet$Motion;->mTransitionEasing:Ljava/lang/String;
    ...
    iget v1, v1, Landroid/support/constraint/ConstraintSet$Motion;->mPathMotionArc:I
    ...
    iget v1, v1, Landroid/support/constraint/ConstraintSet$Motion;->mPathRotate:F

    iput v1, v0, Landroid/support/constraint/motion/MotionPaths;->mPathRotate:F

    .line 684
    iget-object v1, p1, Landroid/support/constraint/ConstraintSet$Constraint;->motion:Landroid/support/constraint/ConstraintSet$Motion;

    iget v1, v1, Landroid/support/constraint/ConstraintSet$Motion;->mDrawPath:I

    iput v1, v0, Landroid/support/constraint/motion/MotionPaths;->mDrawPath:I

    .line 685
    iget-object v1, p1, Landroid/support/constraint/ConstraintSet$Constraint;->propertySet:Landroid/support/constraint/ConstraintSet$PropertySet;

    iget v1, v1, Landroid/support/constraint/ConstraintSet$PropertySet;->mProgress:F

    iput v1, v0, Landroid/support/constraint/motion/MotionPaths;->mProgress:F

    .line 686
    iget-object v1, p1, Landroid/support/constraint/ConstraintSet$Constraint;->mCustomConstraints:Ljava/util/HashMap;
    ...
    iget-object v4, p1, Landroid/support/constraint/ConstraintSet$Constraint;->mCustomConstraints:Ljava/util/HashMap;
    ...
    .line 689
    .local v4, "attr":Landroid/support/constraint/ConstraintAttribute;
    invoke-virtual {v4}, Landroid/support/constraint/ConstraintAttribute;->getType()Landroid/support/constraint/ConstraintAttribute$AttributeType;

    move-result-object v5

    sget-object v6, Landroid/support/constraint/ConstraintAttribute$AttributeType;->STRING_TYPE:Landroid/support/constraint/ConstraintAttribute$AttributeType;

    if-eq v5, v6, :cond_0

    .line 690
    iget-object v5, p0, Landroid/support/constraint/motion/MotionPaths;->attributes:Ljava/util/LinkedHashMap;

    invoke-virtual {v5, v3, v4}, Ljava/util/LinkedHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 692
    .end local v3    # "s":Ljava/lang/String;
    .end local v4    # "attr":Landroid/support/constraint/ConstraintAttribute;
    :cond_0
    goto :goto_0
...
.method public compareTo(Landroid/support/constraint/motion/MotionPaths;)I
    .locals 2
    .param p1, "o"    # Landroid/support/constraint/motion/MotionPaths;

    .line 676
    iget v0, p0, Landroid/support/constraint/motion/MotionPaths;->position:F

    iget v1, p1, Landroid/support/constraint/motion/MotionPaths;->position:F
...
.method different(Landroid/support/constraint/motion/MotionPaths;[Z[Ljava/lang/String;Z)V
    .locals 5
    .param p1, "points"    # Landroid/support/constraint/motion/MotionPaths;
    .param p2, "mask"    # [Z
    ...
    iget v3, p0, Landroid/support/constraint/motion/MotionPaths;->position:F

    iget v4, p1, Landroid/support/constraint/motion/MotionPaths;->position:F

    invoke-direct {p0, v3, v4}, Landroid/support/constraint/motion/MotionPaths;->diff(FF)Z
    ...
    iget v3, p0, Landroid/support/constraint/motion/MotionPaths;->x:F

    iget v4, p1, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iget v3, p0, Landroid/support/constraint/motion/MotionPaths;->y:F

    iget v4, p1, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iget v3, p0, Landroid/support/constraint/motion/MotionPaths;->width:F

    iget v4, p1, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v4, p1, Landroid/support/constraint/motion/MotionPaths;->height:F
...
.method getRect([I[D[FI)V
    ...
    iget v2, v0, Landroid/support/constraint/motion/MotionPaths;->x:F

    .line 433
    .local v2, "v_x":F
    iget v3, v0, Landroid/support/constraint/motion/MotionPaths;->y:F

    .line 434
    .local v3, "v_y":F
    iget v4, v0, Landroid/support/constraint/motion/MotionPaths;->width:F

    .line 435
    .local v4, "v_width":F
    iget v5, v0, Landroid/support/constraint/motion/MotionPaths;->height:F
    ...
    invoke-static/range {v27 .. v32}, Landroid/support/constraint/motion/MotionPaths;->xRotate(FFFFFF)F

    move-result v3

    .line 511
    .local v3, "tx1":F
    invoke-static/range {v27 .. v32}, Landroid/support/constraint/motion/MotionPaths;->yRotate(FFFFFF)F
...
.method initCartesian(Landroid/support/constraint/motion/KeyPosition;Landroid/support/constraint/motion/MotionPaths;Landroid/support/constraint/motion/MotionPaths;)V
    .locals 22
    .param p1, "c"    # Landroid/support/constraint/motion/KeyPosition;
    .param p2, "startTimePoint"    # Landroid/support/constraint/motion/MotionPaths;
    .param p3, "endTimePoint"    # Landroid/support/constraint/motion/MotionPaths;
    ...
    iget v3, v0, Landroid/support/constraint/motion/KeyPosition;->mFramePosition:I
    ...
    .line 82
    .local v4, "point":Landroid/support/constraint/motion/MotionPaths;
    iput v3, v4, Landroid/support/constraint/motion/MotionPaths;->time:F

    .line 84
    iget v5, v0, Landroid/support/constraint/motion/KeyPosition;->mDrawPath:I

    move-object/from16 v6, p0

    iput v5, v6, Landroid/support/constraint/motion/MotionPaths;->mDrawPath:I

    .line 85
    iget v5, v0, Landroid/support/constraint/motion/KeyPosition;->mPercentWidth:F
    ...
    :goto_0
    iget v7, v0, Landroid/support/constraint/motion/KeyPosition;->mPercentHeight:F
    ...
    iget v9, v1, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v12, v1, Landroid/support/constraint/motion/MotionPaths;->height:F

    sub-float v13, v11, v12

    .line 90
    .local v13, "scaleY":F
    iget v14, v4, Landroid/support/constraint/motion/MotionPaths;->time:F

    iput v14, v4, Landroid/support/constraint/motion/MotionPaths;->position:F
    ...
    .line 94
    .local v14, "path":F
    iget v15, v1, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iget v3, v1, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iget v6, v2, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iget v8, v2, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iput v15, v4, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iput v3, v4, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iput v3, v4, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iput v3, v4, Landroid/support/constraint/motion/MotionPaths;->height:F

    .line 105
    iget v3, v0, Landroid/support/constraint/motion/KeyPosition;->mPercentX:F
    ...
    .local v3, "dxdx":F
    :goto_2
    iget v9, v0, Landroid/support/constraint/motion/KeyPosition;->mAltPercentY:F
    ...
    .local v9, "dydx":F
    :goto_3
    iget v15, v0, Landroid/support/constraint/motion/KeyPosition;->mPercentY:F
    ...
    .local v15, "dydy":F
    :goto_4
    iget v12, v0, Landroid/support/constraint/motion/KeyPosition;->mAltPercentX:F
    ...
    iput v2, v4, Landroid/support/constraint/motion/MotionPaths;->mMode:I

    .line 110
    iget v2, v1, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iput v2, v4, Landroid/support/constraint/motion/MotionPaths;->x:F

    .line 111
    iget v2, v1, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iput v2, v4, Landroid/support/constraint/motion/MotionPaths;->y:F

    .line 113
    iget-object v2, v0, Landroid/support/constraint/motion/KeyPosition;->mTransitionEasing:Ljava/lang/String;
    ...
    iput-object v2, v4, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    .line 114
    iget v2, v0, Landroid/support/constraint/motion/KeyPosition;->mPathMotionArc:I

    iput v2, v4, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I
...
.method initPath(Landroid/support/constraint/motion/KeyPosition;Landroid/support/constraint/motion/MotionPaths;Landroid/support/constraint/motion/MotionPaths;)V
    ...
    iget v10, v1, Landroid/support/constraint/motion/MotionPaths;->height:F

    sub-float/2addr v9, v10

    .line 193
    .local v9, "scaleY":F
    iget v10, v4, Landroid/support/constraint/motion/MotionPaths;->time:F

    iput v10, v4, Landroid/support/constraint/motion/MotionPaths;->position:F

    .line 195
    iget v10, v0, Landroid/support/constraint/motion/KeyPosition;->mPercentX:F
    ...
    .local v10, "path":F
    :goto_2
    iget v11, v1, Landroid/support/constraint/motion/MotionPaths;->x:F

    iget v12, v1, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v15, v1, Landroid/support/constraint/motion/MotionPaths;->y:F

    move/from16 v16, v3

    .end local v3    # "position":F
    .local v16, "position":F
    iget v3, v1, Landroid/support/constraint/motion/MotionPaths;->height:F
    ...
    iget v1, v2, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v0, v2, Landroid/support/constraint/motion/MotionPaths;->height:F
    ...
    iput v11, v4, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iput v11, v4, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iput v11, v4, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v11, v3, Landroid/support/constraint/motion/KeyPosition;->mPercentY:F
    ...
    iput v1, v4, Landroid/support/constraint/motion/MotionPaths;->mMode:I
    ...
    iget v0, v1, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iput v0, v4, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    .line 219
    iget-object v0, v3, Landroid/support/constraint/motion/KeyPosition;->mTransitionEasing:Ljava/lang/String;
    ...
    iput-object v0, v4, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    .line 220
    iget v0, v3, Landroid/support/constraint/motion/KeyPosition;->mPathMotionArc:I

    iput v0, v4, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I
...
.method initScreen(IILandroid/support/constraint/motion/KeyPosition;Landroid/support/constraint/motion/MotionPaths;Landroid/support/constraint/motion/MotionPaths;)V
    ...
    .line 157
    .local v19, "startCenterY":F
    iget v1, v2, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iput v3, v4, Landroid/support/constraint/motion/MotionPaths;->mMode:I
    ...
    iget v12, v4, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v9, v0, Landroid/support/constraint/motion/KeyPosition;->mPercentX:F
    ...
    iput v9, v4, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    :goto_2
    iget v9, v0, Landroid/support/constraint/motion/KeyPosition;->mPercentY:F
    ...
    iget v15, v4, Landroid/support/constraint/motion/MotionPaths;->height:F
    ...
    iget v12, v0, Landroid/support/constraint/motion/KeyPosition;->mPercentY:F
    ...
    iput v12, v4, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    :goto_3
    iget-object v12, v0, Landroid/support/constraint/motion/KeyPosition;->mTransitionEasing:Ljava/lang/String;

    invoke-static {v12}, Landroid/support/constraint/motion/utils/Easing;->getInterpolator(Ljava/lang/String;)Landroid/support/constraint/motion/utils/Easing;

    move-result-object v12

    iput-object v12, v4, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    .line 177
    iget v12, v0, Landroid/support/constraint/motion/KeyPosition;->mPathMotionArc:I

    iput v12, v4, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I
...
.method setView(Landroid/view/View;[I[D[D[D)V
    ...
    iput-object v14, v0, Landroid/support/constraint/motion/MotionPaths;->mTempValue:[D

    .line 332
    new-array v14, v3, [D

    iput-object v14, v0, Landroid/support/constraint/motion/MotionPaths;->mTempDelta:[D
    ...
    :cond_1
    :goto_0
    iget-object v3, v0, Landroid/support/constraint/motion/MotionPaths;->mTempValue:[D
    ...
    .line 336
    iget-object v4, v0, Landroid/support/constraint/motion/MotionPaths;->mTempValue:[D
    ...
    .line 337
    iget-object v4, v0, Landroid/support/constraint/motion/MotionPaths;->mTempDelta:[D
    ...
    iget-object v2, v0, Landroid/support/constraint/motion/MotionPaths;->mTempValue:[D
    ...
    .line 346
    .local v2, "value":F
    iget-object v14, v0, Landroid/support/constraint/motion/MotionPaths;->mTempDelta:[D
