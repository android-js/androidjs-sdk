...
.method private fill(Landroid/content/res/TypedArray;)V
    ...
    .line 137
    sget-object v4, Landroid/support/constraint/motion/TouchResponse;->TOUCH_SIDES:[[F

    aget-object v3, v4, v3

    aget v4, v3, v1

    iput v4, p0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorX:F
    ...
    .line 141
    sget-object v4, Landroid/support/constraint/motion/TouchResponse;->TOUCH_DIRECTION:[[F

    aget-object v3, v4, v3

    aget v4, v3, v1

    iput v4, p0, Landroid/support/constraint/motion/TouchResponse;->mTouchDirectionX:F
    ...
    .line 151
    :cond_6
    sget v4, Landroid/support/constraint/R$styleable;->OnSwipe_dragThreshold:I

    if-ne v3, v4, :cond_7

    .line 152
    iget v4, p0, Landroid/support/constraint/motion/TouchResponse;->mDragThreshold:F
    ...
    .line 153
    :cond_7
    sget v4, Landroid/support/constraint/R$styleable;->OnSwipe_touchRegionId:I

    if-ne v3, v4, :cond_8

    .line 154
    iget v4, p0, Landroid/support/constraint/motion/TouchResponse;->mTouchRegionId:I
    ...
    .line 155
    :cond_8
    sget v4, Landroid/support/constraint/R$styleable;->OnSwipe_onTouchUp:I

    if-ne v3, v4, :cond_9

    .line 156
    iget v4, p0, Landroid/support/constraint/motion/TouchResponse;->mOnTouchUp:I
    ...
    .line 157
    :cond_9
    sget v4, Landroid/support/constraint/R$styleable;->OnSwipe_nestedScrollFlags:I
    ...
    .line 159
    :cond_a
    sget v4, Landroid/support/constraint/R$styleable;->OnSwipe_limitBoundsTo:I
...
.method processTouchEvent(Landroid/view/MotionEvent;Landroid/support/constraint/motion/MotionLayout$MotionTracker;ILandroid/support/constraint/motion/MotionScene;)V
    ...
    iget v12, v0, Landroid/support/constraint/motion/TouchResponse;->mDragThreshold:F

    cmpl-float v11, v11, v12

    if-gtz v11, :cond_1

    iget-boolean v11, v0, Landroid/support/constraint/motion/TouchResponse;->mDragStarted:Z
    ...
    .line 210
    :cond_2
    iget v13, v0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorId:I
    ...
    iget v15, v0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorX:F

    iget v5, v0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorY:F

    iget-object v14, v0, Landroid/support/constraint/motion/TouchResponse;->mAnchorDpDt:[F
    ...
    invoke-virtual/range {v12 .. v17}, Landroid/support/constraint/motion/MotionLayout;->getAnchorDpDt(IFFF[F)V
    ...
    .line 221
    iget-object v12, v0, Landroid/support/constraint/motion/TouchResponse;->mAnchorDpDt:[F
    ...
    .line 233
    iget v12, v0, Landroid/support/constraint/motion/TouchResponse;->mDragScale:F
    ...
    .line 242
    iget-object v3, v0, Landroid/support/constraint/motion/TouchResponse;->mAnchorDpDt:[F
    ...
    .line 256
    invoke-interface {v1, v6}, Landroid/support/constraint/motion/MotionLayout$MotionTracker;->computeCurrentVelocity(I)V
    ...
    iget-object v1, v0, Landroid/support/constraint/motion/TouchResponse;->mAnchorDpDt:[F
    ...
    .line 260
    :goto_2
    iget-object v1, v0, Landroid/support/constraint/motion/TouchResponse;->mMotionLayout:Landroid/support/constraint/motion/MotionLayout;

    iput v3, v1, Landroid/support/constraint/motion/MotionLayout;->mLastVelocity:F
    ...
    iput v8, v1, Landroid/support/constraint/motion/MotionLayout;->mLastVelocity:F
    ...
    iput v1, v0, Landroid/support/constraint/motion/TouchResponse;->mLastTouchX:F
    ...
    iput v1, v0, Landroid/support/constraint/motion/TouchResponse;->mLastTouchY:F

    goto/16 :goto_8

    .line 269
    :cond_8
    iput-boolean v4, v0, Landroid/support/constraint/motion/TouchResponse;->mDragStarted:Z
    ...
    .line 273
    iget-object v3, v0, Landroid/support/constraint/motion/TouchResponse;->mMotionLayout:Landroid/support/constraint/motion/MotionLayout;
    ...
    .line 279
    iget v11, v0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorId:I
    ...
    iget v13, v0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorX:F

    iget v14, v0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorY:F

    iget-object v15, v0, Landroid/support/constraint/motion/TouchResponse;->mAnchorDpDt:[F

    move v12, v3

    invoke-virtual/range {v10 .. v15}, Landroid/support/constraint/motion/MotionLayout;->getAnchorDpDt(IFFF[F)V
    ...
    invoke-virtual {v6}, Landroid/support/constraint/motion/MotionLayout;->getHeight()I
    ...
    .line 283
    iget-object v6, v0, Landroid/support/constraint/motion/TouchResponse;->mAnchorDpDt:[F

    iget v10, v0, Landroid/support/constraint/motion/TouchResponse;->mTouchDirectionY:F
    ...
    .line 284
    iget v10, v0, Landroid/support/constraint/motion/TouchResponse;->mTouchDirectionX:F
    ...
    .line 302
    iget v4, v0, Landroid/support/constraint/motion/TouchResponse;->mOnTouchUp:I
    ...
    :goto_7
    invoke-virtual {v5, v4, v1, v2}, Landroid/support/constraint/motion/MotionLayout;->touchAnimateTo(IFF)V
...
.method scrollUp(FF)V
    ...
    :goto_2
    invoke-virtual {v0, v3, v7, p1}, Landroid/support/constraint/motion/MotionLayout;->touchAnimateTo(IFF)V
...
.method public setRTL(Z)V
    ...
    .line 108
    sget-object p1, Landroid/support/constraint/motion/TouchResponse;->TOUCH_DIRECTION:[[F
    ...
    .line 110
    sget-object p1, Landroid/support/constraint/motion/TouchResponse;->TOUCH_SIDES:[[F
    ...
    iget v0, p0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorSide:I
    ...
    iput p1, p0, Landroid/support/constraint/motion/TouchResponse;->mTouchAnchorY:F

    .line 120
    sget-object p1, Landroid/support/constraint/motion/TouchResponse;->TOUCH_DIRECTION:[[F

    iget v1, p0, Landroid/support/constraint/motion/TouchResponse;->mTouchSide:I

    aget-object p1, p1, v1

    aget v0, p1, v0

    iput v0, p0, Landroid/support/constraint/motion/TouchResponse;->mTouchDirectionX:F

    .line 121
    aget p1, p1, v3

    iput p1, p0, Landroid/support/constraint/motion/TouchResponse;->mTouchDirectionY:F
...
.method setupTouch()V
    ...
    invoke-virtual {v1, v0}, Landroid/support/constraint/motion/MotionLayout;->findViewById(I)Landroid/view/View;
