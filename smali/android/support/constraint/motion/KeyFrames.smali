...
.method public constructor <init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 71
    .local v1, "key":Landroid/support/constraint/motion/Key;
    :try_start_0
    ...
    invoke-virtual {v1, p1, v3}, Landroid/support/constraint/motion/Key;->load(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iget-object v3, v1, Landroid/support/constraint/motion/Key;->mCustomConstraints:Ljava/util/HashMap;
    ...
    .line 72
    .end local v1    # "key":Landroid/support/constraint/motion/Key;
...
.method public addFrames(Landroid/support/constraint/motion/MotionController;)V
    ...
    .line 112
    .local v0, "list":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/motion/Key;>;"
    if-eqz v0, :cond_0
    ...
    .line 115
    :cond_0
    iget-object v1, p0, Landroid/support/constraint/motion/KeyFrames;->mFramesMap:Ljava/util/HashMap;
    ...
    .line 119
    .local v2, "key":Landroid/support/constraint/motion/Key;
    iget-object v3, p1, Landroid/support/constraint/motion/MotionController;->mView:Landroid/view/View;
    ...
    iget-object v3, v3, Landroid/support/constraint/ConstraintLayout$LayoutParams;->constraintTag:Ljava/lang/String;

    .line 120
    .local v3, "tag":Ljava/lang/String;
    invoke-virtual {v2, v3}, Landroid/support/constraint/motion/Key;->matches(Ljava/lang/String;)Z
    ...
    .line 121
    invoke-virtual {p1, v2}, Landroid/support/constraint/motion/MotionController;->addKey(Landroid/support/constraint/motion/Key;)V

    .line 123
    .end local v2    # "key":Landroid/support/constraint/motion/Key;
