...
.method public setProperty(Landroid/view/View;FJLandroid/support/constraint/motion/KeyCache;)Z
    ...
    .line 361
    iget-object p5, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mCurveFit:Landroid/support/constraint/motion/utils/CurveFit;

    float-to-double v0, p2

    iget-object p2, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mTempValues:[F

    invoke-virtual {p5, v0, v1, p2}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[F)V
    ...
    .line 364
    iget-wide v2, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->last_time:J

    sub-long v2, p3, v2

    .line 365
    iget v0, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->last_cycle:F
    ...
    iput v0, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->last_cycle:F

    .line 366
    iput-wide p3, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->last_time:J

    .line 367
    iget p3, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->last_cycle:F

    invoke-virtual {p0, p3}, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->calcWave(F)F
    ...
    .line 368
    iput-boolean p4, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mContinue:Z

    const/4 v0, 0x0

    .line 369
    :goto_0
    iget-object v2, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mCache:[F
    ...
    .line 370
    iget-boolean v2, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mContinue:Z

    iget-object v3, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mTempValues:[F
    ...
    iput-boolean v2, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mContinue:Z
    ...
    .line 373
    :cond_1
    iget-object p2, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mConstraintAttributeList:Landroid/util/SparseArray;
    ...
    iget-object p3, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mCache:[F

    invoke-virtual {p2, p1, p3}, Landroid/support/constraint/ConstraintAttribute;->setInterpolatedValue(Landroid/view/View;[F)V
    ...
    .line 375
    iput-boolean v1, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mContinue:Z

    .line 377
    :cond_2
    iget-boolean p1, p0, Landroid/support/constraint/motion/TimeCycleSplineSet$CustomSet;->mContinue:Z
