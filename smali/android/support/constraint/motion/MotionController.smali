...
.method private getAdjustedPosition(F[F)F
    ...
    .line 878
    :cond_0
    iget v3, p0, Landroid/support/constraint/motion/MotionController;->mStaggerScale:F
    ...
    .line 879
    iget v4, p0, Landroid/support/constraint/motion/MotionController;->mStaggerOffset:F
...
.method buildBounds([FI)V
    ...
    .line 212
    iget-object v2, p0, Landroid/support/constraint/motion/MotionController;->mAttributesMap:Ljava/util/HashMap;
    ...
    .line 214
    :goto_1
    iget-object v2, p0, Landroid/support/constraint/motion/MotionController;->mCycleMap:Ljava/util/HashMap;
    ...
    check-cast v2, Landroid/support/constraint/motion/KeyCycleOscillator;
    ...
    .line 219
    iget v5, p0, Landroid/support/constraint/motion/MotionController;->mStaggerScale:F
    ...
    .line 220
    iget v7, p0, Landroid/support/constraint/motion/MotionController;->mStaggerOffset:F
    ...
    iget-object v5, v5, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    const/high16 v9, 0x7fc00000    # Float.NaN

    .line 233
    iget-object v10, p0, Landroid/support/constraint/motion/MotionController;->mMotionPaths:Ljava/util/ArrayList;
    ...
    check-cast v11, Landroid/support/constraint/motion/MotionPaths;

    .line 234
    iget-object v12, v11, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    if-eqz v12, :cond_6

    .line 235
    iget v12, v11, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 236
    iget-object v5, v11, Landroid/support/constraint/motion/MotionPaths;->mKeyFrameEasing:Landroid/support/constraint/motion/utils/Easing;

    .line 237
    iget v6, v11, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 240
    iget v9, v11, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 251
    invoke-virtual {v5, v7, v8}, Landroid/support/constraint/motion/utils/Easing;->get(D)D
    ...
    invoke-virtual {v4, v7, v8, v5}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V

    .line 257
    iget-object v4, p0, Landroid/support/constraint/motion/MotionController;->mArcSpline:Landroid/support/constraint/motion/utils/CurveFit;
    ...
    invoke-virtual {v4, v5, v6, p1, v7}, Landroid/support/constraint/motion/MotionPaths;->getBounds([I[D[FI)V
...
.method buildKeyBounds([F[I)I
    ...
    invoke-virtual {v3, v4, v5, p1, v2}, Landroid/support/constraint/motion/MotionPaths;->getBounds([I[D[FI)V
...
.method buildPath([FI)V
    ...
    .line 143
    iget v12, v0, Landroid/support/constraint/motion/MotionController;->mStaggerScale:F
    ...
    .line 144
    iget v14, v0, Landroid/support/constraint/motion/MotionController;->mStaggerOffset:F
    ...
    .line 157
    iget-object v13, v0, Landroid/support/constraint/motion/MotionController;->mMotionPaths:Ljava/util/ArrayList;
    ...
    check-cast v15, Landroid/support/constraint/motion/MotionPaths;
    ...
    .line 159
    iget v9, v15, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 161
    iget v12, v15, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    .line 175
    invoke-virtual {v12, v4, v5}, Landroid/support/constraint/motion/utils/Easing;->get(D)D
    ...
    .line 180
    :cond_b
    iget-object v9, v0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;

    const/4 v12, 0x0

    aget-object v9, v9, v12

    iget-object v13, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D

    invoke-virtual {v9, v4, v5, v13}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V

    .line 181
    iget-object v9, v0, Landroid/support/constraint/motion/MotionController;->mArcSpline:Landroid/support/constraint/motion/utils/CurveFit;
    ...
    invoke-virtual {v4, v5, v9, v1, v13}, Landroid/support/constraint/motion/MotionPaths;->getCenter([I[D[FI)V
    ...
    invoke-virtual {v7, v11}, Landroid/support/constraint/motion/KeyCycleOscillator;->get(F)F
    ...
    invoke-virtual {v8, v11}, Landroid/support/constraint/motion/SplineSet;->get(F)F
...
.method buildRectangles([FI)V
    ...
    .line 401
    invoke-direct {p0, v3, v4}, Landroid/support/constraint/motion/MotionController;->getAdjustedPosition(F[F)F
    ...
    invoke-virtual {v4, v5, v6, v3}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V
...
.method getAttributeValues(Ljava/lang/String;[FI)I
    ...
    .line 381
    iget-object p3, p0, Landroid/support/constraint/motion/MotionController;->mAttributesMap:Ljava/util/HashMap;

    invoke-virtual {p3, p1}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/support/constraint/motion/SplineSet;
    ...
    invoke-virtual {p1, v0}, Landroid/support/constraint/motion/SplineSet;->get(F)F
...
.method getDpDt(FFF[F)V
    ...
    .line 1060
    :goto_0
    iget-object v9, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateVelocity:[D
    ...
    .line 1064
    :cond_0
    iget-object p1, p0, Landroid/support/constraint/motion/MotionController;->mArcSpline:Landroid/support/constraint/motion/utils/CurveFit;
    ...
    iget-object v0, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateVelocity:[D

    invoke-virtual {p1, v2, v3, v0}, Landroid/support/constraint/motion/utils/CurveFit;->getSlope(D[D)V

    .line 1068
    iget-object v4, p0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget-object v8, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateVariables:[I

    iget-object v9, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateVelocity:[D

    iget-object v10, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D
    ...
    invoke-virtual/range {v4 .. v10}, Landroid/support/constraint/motion/MotionPaths;->setDpDt(FF[F[I[D[D)V
...
.method public getKeyFrameInfo(I[I)I
    ...
    .line 1240
    iget v6, v5, Landroid/support/constraint/motion/Key;->mType:I
    ...
    .line 1246
    iget v7, v5, Landroid/support/constraint/motion/Key;->mType:I
    ...
    .line 1247
    iget v8, v5, Landroid/support/constraint/motion/Key;->mFramePosition:I
    ...
    invoke-virtual {v9, v10, v11, v8}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V

    .line 1251
    iget-object v8, p0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget-object v9, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateVariables:[I

    iget-object v10, p0, Landroid/support/constraint/motion/MotionController;->mInterpolateData:[D

    invoke-virtual {v8, v9, v10, v0, v2}, Landroid/support/constraint/motion/MotionPaths;->getCenter([I[D[FI)V
    ...
    .line 1254
    instance-of v8, v5, Landroid/support/constraint/motion/KeyPosition;

    if-eqz v8, :cond_1

    .line 1255
    check-cast v5, Landroid/support/constraint/motion/KeyPosition;

    add-int/lit8 v6, v6, 0x1

    .line 1256
    iget v8, v5, Landroid/support/constraint/motion/KeyPosition;->mPositionType:I
    ...
    .line 1258
    iget v8, v5, Landroid/support/constraint/motion/KeyPosition;->mPercentX:F
    ...
    .line 1259
    iget v5, v5, Landroid/support/constraint/motion/KeyPosition;->mPercentY:F
...
.method getPositionKeyframe(IIFF)Landroid/support/constraint/motion/KeyPositionBase;
    ...
    .line 326
    instance-of v1, v0, Landroid/support/constraint/motion/KeyPositionBase;
    ...
    check-cast v10, Landroid/support/constraint/motion/KeyPositionBase;
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/constraint/motion/KeyPositionBase;->intersects(IILandroid/graphics/RectF;Landroid/graphics/RectF;FF)Z
...
.method getPostLayoutDvDp(FIIFF[F)V
    ...
    .line 1103
    iget-object v2, v0, Landroid/support/constraint/motion/MotionController;->mAttributesMap:Ljava/util/HashMap;
    ...
    .line 1109
    :goto_4
    iget-object v13, v0, Landroid/support/constraint/motion/MotionController;->mCycleMap:Ljava/util/HashMap;
    ...
    check-cast v10, Landroid/support/constraint/motion/KeyCycleOscillator;
    ...
    check-cast v4, Landroid/support/constraint/motion/KeyCycleOscillator;

    .line 1115
    :goto_9
    new-instance v12, Landroid/support/constraint/motion/utils/VelocityMatrix;

    invoke-direct {v12}, Landroid/support/constraint/motion/utils/VelocityMatrix;-><init>()V

    .line 1116
    invoke-virtual {v12}, Landroid/support/constraint/motion/utils/VelocityMatrix;->clear()V

    .line 1117
    invoke-virtual {v12, v7, v1}, Landroid/support/constraint/motion/utils/VelocityMatrix;->setRotationVelocity(Landroid/support/constraint/motion/SplineSet;F)V

    .line 1118
    invoke-virtual {v12, v2, v5, v1}, Landroid/support/constraint/motion/utils/VelocityMatrix;->setTranslationVelocity(Landroid/support/constraint/motion/SplineSet;Landroid/support/constraint/motion/SplineSet;F)V

    .line 1119
    invoke-virtual {v12, v9, v11, v1}, Landroid/support/constraint/motion/utils/VelocityMatrix;->setScaleVelocity(Landroid/support/constraint/motion/SplineSet;Landroid/support/constraint/motion/SplineSet;F)V

    .line 1120
    invoke-virtual {v12, v8, v1}, Landroid/support/constraint/motion/utils/VelocityMatrix;->setRotationVelocity(Landroid/support/constraint/motion/KeyCycleOscillator;F)V

    .line 1121
    invoke-virtual {v12, v3, v6, v1}, Landroid/support/constraint/motion/utils/VelocityMatrix;->setTranslationVelocity(Landroid/support/constraint/motion/KeyCycleOscillator;Landroid/support/constraint/motion/KeyCycleOscillator;F)V

    .line 1122
    invoke-virtual {v12, v10, v4, v1}, Landroid/support/constraint/motion/utils/VelocityMatrix;->setScaleVelocity(Landroid/support/constraint/motion/KeyCycleOscillator;Landroid/support/constraint/motion/KeyCycleOscillator;F)V

    .line 1123
    iget-object v13, v0, Landroid/support/constraint/motion/MotionController;->mArcSpline:Landroid/support/constraint/motion/utils/CurveFit;
    ...
    .line 1125
    invoke-virtual {v13, v3, v4, v2}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V
    ...
    invoke-virtual {v1, v3, v4, v2}, Landroid/support/constraint/motion/utils/CurveFit;->getSlope(D[D)V
    ...
    .line 1132
    :cond_b
    iget-object v13, v0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;
    ...
    .line 1133
    iget-object v2, v0, Landroid/support/constraint/motion/MotionController;->mVelocity:[F

    invoke-direct {v0, v1, v2}, Landroid/support/constraint/motion/MotionController;->getAdjustedPosition(F[F)F
    ...
    invoke-virtual {v2, v3, v4, v1}, Landroid/support/constraint/motion/utils/CurveFit;->getSlope(D[D)V
    ...
    iget v13, v13, Landroid/support/constraint/motion/MotionPaths;->x:F

    iget-object v15, v0, Landroid/support/constraint/motion/MotionController;->mStartMotionPath:Landroid/support/constraint/motion/MotionPaths;

    iget v15, v15, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iget v15, v15, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iget v14, v14, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    iget v14, v14, Landroid/support/constraint/motion/MotionPaths;->width:F
    ...
    iget v10, v10, Landroid/support/constraint/motion/MotionPaths;->height:F
...
.method public getkeyFramePositions([I[F)I
    ...
    .line 1209
    iget v6, v4, Landroid/support/constraint/motion/Key;->mFramePosition:I
    ...
    .line 1210
    iget v2, v4, Landroid/support/constraint/motion/Key;->mFramePosition:I
    ...
    invoke-virtual {v4, v6, v7, v2}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V
    ...
    invoke-virtual {v2, v4, v6, p2, v3}, Landroid/support/constraint/motion/MotionPaths;->getCenter([I[D[FI)V
...
.method interpolate(Landroid/view/View;FJLandroid/support/constraint/motion/KeyCache;)Z
    ...
    check-cast v3, Landroid/support/constraint/motion/SplineSet;

    .line 937
    invoke-virtual {v3, v11, v12}, Landroid/support/constraint/motion/SplineSet;->setProperty(Landroid/view/View;F)V

    goto :goto_0

    .line 941
    :cond_0
    iget-object v2, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;
    ...
    check-cast v1, Landroid/support/constraint/motion/TimeCycleSplineSet;

    .line 943
    instance-of v2, v1, Landroid/support/constraint/motion/TimeCycleSplineSet$PathRotate;
    ...
    check-cast v8, Landroid/support/constraint/motion/TimeCycleSplineSet$PathRotate;
    ...
    invoke-virtual {v1, v9, v10, v2}, Landroid/support/constraint/motion/utils/CurveFit;->getPos(D[D)V
    ...
    invoke-virtual {v1, v9, v10, v2}, Landroid/support/constraint/motion/utils/CurveFit;->getSlope(D[D)V
    ...
    .line 978
    iget-object v3, v0, Landroid/support/constraint/motion/MotionController;->mValuesBuff:[F
    ...
    invoke-virtual {v2, v12, v11}, Landroid/support/constraint/motion/KeyTrigger;->conditionallyFire(FLandroid/view/View;)V
    ...
    .line 1034
    :cond_10
    invoke-virtual {v1, v11, v12}, Landroid/support/constraint/motion/KeyCycleOscillator;->setProperty(Landroid/view/View;F)V
...
.method positionKeyframe(Landroid/view/View;Landroid/support/constraint/motion/KeyPositionBase;FF[Ljava/lang/String;[F)V
    ...
    .line 1195
    invoke-virtual/range {v0 .. v7}, Landroid/support/constraint/motion/KeyPositionBase;->positionAttributes(Landroid/view/View;Landroid/graphics/RectF;Landroid/graphics/RectF;FF[Ljava/lang/String;[F)V
...
.method setStartState(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/ConstraintSet;)V
    ...
    .line 852
    iget-object v0, v0, Landroid/support/constraint/ConstraintSet$Constraint;->motion:Landroid/support/constraint/ConstraintSet$Motion;

    iget v0, v0, Landroid/support/constraint/ConstraintSet$Motion;->mMotionStagger:F
...
.method public setView(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroid/support/constraint/motion/MotionController;->mConstraintTag:Ljava/lang/String;
...
.method public setup(IIFJ)V
    ...
    .line 491
    iget v5, v0, Landroid/support/constraint/motion/MotionController;->mPathMotionArc:I
    ...
    iget v6, v0, Landroid/support/constraint/motion/MotionController;->mPathMotionArc:I

    iput v6, v5, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I
    ...
    .line 564
    iget-object v6, v15, Landroid/support/constraint/motion/Key;->mCustomConstraints:Ljava/util/HashMap;
    ...
    .line 569
    iget v15, v15, Landroid/support/constraint/motion/Key;->mFramePosition:I
    ...
    .line 579
    :cond_e
    invoke-virtual {v6, v11}, Landroid/support/constraint/motion/SplineSet;->setType(Ljava/lang/String;)V

    .line 580
    iget-object v12, v0, Landroid/support/constraint/motion/MotionController;->mAttributesMap:Ljava/util/HashMap;
    ...
    .line 582
    :cond_f
    iget-object v6, v0, Landroid/support/constraint/motion/MotionController;->mKeyList:Ljava/util/ArrayList;
    ...
    .line 584
    instance-of v11, v7, Landroid/support/constraint/motion/KeyAttributes;
    ...
    invoke-virtual {v7, v11}, Landroid/support/constraint/motion/Key;->addValues(Ljava/util/HashMap;)V

    goto :goto_4

    .line 589
    :cond_11
    iget-object v6, v0, Landroid/support/constraint/motion/MotionController;->mStartPoint:Landroid/support/constraint/motion/MotionConstrainedPoint;

    iget-object v7, v0, Landroid/support/constraint/motion/MotionController;->mAttributesMap:Ljava/util/HashMap;

    invoke-virtual {v6, v7, v5}, Landroid/support/constraint/motion/MotionConstrainedPoint;->addValues(Ljava/util/HashMap;I)V
    ...
    invoke-virtual {v6, v7, v11}, Landroid/support/constraint/motion/MotionConstrainedPoint;->addValues(Ljava/util/HashMap;I)V

    .line 592
    iget-object v6, v0, Landroid/support/constraint/motion/MotionController;->mAttributesMap:Ljava/util/HashMap;
    ...
    invoke-virtual {v7, v11}, Landroid/support/constraint/motion/SplineSet;->setup(I)V
    ...
    .line 603
    iget-object v6, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;
    ...
    iput-object v6, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;
    ...
    .line 607
    iget-object v7, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;
    ...
    .line 624
    :cond_18
    invoke-static {v6, v7}, Landroid/support/constraint/motion/TimeCycleSplineSet;->makeCustomSpline(Ljava/lang/String;Landroid/util/SparseArray;)Landroid/support/constraint/motion/TimeCycleSplineSet;
    ...
    .line 626
    invoke-static {v6, v11, v12}, Landroid/support/constraint/motion/TimeCycleSplineSet;->makeSpline(Ljava/lang/String;J)Landroid/support/constraint/motion/TimeCycleSplineSet;
    ...
    .line 632
    :cond_1a
    invoke-virtual {v7, v6}, Landroid/support/constraint/motion/TimeCycleSplineSet;->setType(Ljava/lang/String;)V

    .line 633
    iget-object v13, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;
    ...
    check-cast v6, Landroid/support/constraint/motion/Key;

    .line 638
    instance-of v7, v6, Landroid/support/constraint/motion/KeyTimeCycle;

    if-eqz v7, :cond_1c

    .line 639
    check-cast v6, Landroid/support/constraint/motion/KeyTimeCycle;

    iget-object v7, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;

    invoke-virtual {v6, v7}, Landroid/support/constraint/motion/KeyTimeCycle;->addTimeValues(Ljava/util/HashMap;)V
    ...
    .line 649
    :goto_c
    iget-object v8, v0, Landroid/support/constraint/motion/MotionController;->mTimeCycleAttributesMap:Ljava/util/HashMap;

    invoke-virtual {v8, v6}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/support/constraint/motion/TimeCycleSplineSet;

    invoke-virtual {v6, v7}, Landroid/support/constraint/motion/TimeCycleSplineSet;->setup(I)V
    ...
    new-array v6, v1, [Landroid/support/constraint/motion/MotionPaths;
    ...
    .line 658
    iget-object v8, v0, Landroid/support/constraint/motion/MotionController;->mEndMotionPath:Landroid/support/constraint/motion/MotionPaths;
    ...
    .line 669
    iget-object v11, v0, Landroid/support/constraint/motion/MotionController;->mEndMotionPath:Landroid/support/constraint/motion/MotionPaths;
    ...
    iget-object v13, v13, Landroid/support/constraint/motion/MotionPaths;->attributes:Ljava/util/LinkedHashMap;
    ...
    .line 681
    :goto_f
    iget-object v8, v0, Landroid/support/constraint/motion/MotionController;->mAttributeNames:[Ljava/lang/String;
    ...
    .line 683
    iget-object v9, v0, Landroid/support/constraint/motion/MotionController;->mAttributeInterpCount:[I
    ...
    .line 686
    iget-object v11, v0, Landroid/support/constraint/motion/MotionController;->mAttributeInterpCount:[I

    aget v12, v11, v2

    aget-object v9, v6, v9

    iget-object v9, v9, Landroid/support/constraint/motion/MotionPaths;->attributes:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v8}, Landroid/support/constraint/ConstraintAttribute;->noOfInterpValues()I
    ...
    iget-object v13, v0, Landroid/support/constraint/motion/MotionController;->mAttributeNames:[Ljava/lang/String;

    invoke-virtual {v11, v12, v8, v13, v2}, Landroid/support/constraint/motion/MotionPaths;->different(Landroid/support/constraint/motion/MotionPaths;[Z[Ljava/lang/String;Z)V
    ...
    iput-object v2, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVariables:[I
    ...
    iput-object v2, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVelocity:[D
    ...
    .line 711
    iget-object v11, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVariables:[I
    ...
    invoke-virtual {v9, v11, v12}, Landroid/support/constraint/motion/MotionPaths;->fillStandard([D[I)V
    ...
    new-array v8, v8, [Landroid/support/constraint/motion/utils/CurveFit;

    iput-object v8, v0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;
    ...
    invoke-virtual {v11, v9}, Landroid/support/constraint/motion/MotionPaths;->hasCustomData(Ljava/lang/String;)Z
    ...
    invoke-virtual {v13, v9}, Landroid/support/constraint/motion/MotionPaths;->getCustomDataCount(Ljava/lang/String;)I
    ...
    iget v11, v11, Landroid/support/constraint/motion/MotionPaths;->time:F
    ...
    invoke-virtual {v10, v9, v11, v5}, Landroid/support/constraint/motion/MotionPaths;->getCustomData(Ljava/lang/String;[DI)I
    ...
    .line 752
    iget-object v11, v0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;

    add-int/lit8 v8, v8, 0x1

    iget v12, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I

    invoke-static {v12, v9, v10}, Landroid/support/constraint/motion/utils/CurveFit;->get(I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    .line 755
    :cond_33
    iget-object v8, v0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;

    iget v9, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I

    invoke-static {v9, v7, v2}, Landroid/support/constraint/motion/utils/CurveFit;->get(I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    iget v9, v9, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I
    ...
    iget v10, v10, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iget v10, v10, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    .line 769
    :cond_34
    invoke-static {v2, v7, v4}, Landroid/support/constraint/motion/utils/CurveFit;->getArc([I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
