...
.method public constructor <init>([I[D[[D)V
    ...
    .line 188
    :goto_2
    new-instance v21, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;
    ...
    invoke-direct/range {v7 .. v20}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;-><init>(IDDDDDD)V
...
.method public getPos(DI)D
    ...
    iget-wide p1, v0, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->mTime1:D
    ...
    iget-wide v0, v0, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->mTime2:D
    ...
    iget-wide p1, v0, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->mTime2:D
    ...
    iget-wide v1, v1, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->mTime2:D
    ...
    iget-boolean v1, v1, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->linear:Z
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getLinearX(D)D
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->setPoint(D)V
    ...
    invoke-virtual {v1}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getX()D
    ...
    invoke-virtual {v1}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getY()D
...
.method public getPos(D[D)V
    ...
    invoke-virtual {v2}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getX()D
...
.method public getPos(D[F)V
    ...
    iget-wide p1, v2, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->mTime1:D
    ...
    iget-wide p1, v2, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->mTime2:D
    ...
    invoke-virtual {v3}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getX()D
...
.method public getSlope(DI)D
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getLinearDX(D)D
    ...
    invoke-virtual {v1}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getDX()D
    ...
    invoke-virtual {v1}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getDY()D
...
.method public getSlope(D[D)V
    ...
    invoke-virtual {v3}, Landroid/support/constraint/motion/utils/ArcCurveFit$Arc;->getDX()D
