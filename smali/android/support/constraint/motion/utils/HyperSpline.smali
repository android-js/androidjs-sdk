...
.method static calcNaturalCubic(I[D)[Landroid/support/constraint/motion/utils/HyperSpline$Cubic;
    ...
    .line 170
    :cond_2
    new-array v1, v0, [Landroid/support/constraint/motion/utils/HyperSpline$Cubic;

    :goto_3
    if-ge v4, v0, :cond_3

    .line 172
    new-instance v2, Landroid/support/constraint/motion/utils/HyperSpline$Cubic;
    ...
    invoke-direct/range {v13 .. v21}, Landroid/support/constraint/motion/utils/HyperSpline$Cubic;-><init>(DDDD)V
...
.method public getPos(DI)D
    ...
    .line 114
    :goto_0
    iget-object v1, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mCurveLength:[D
    ...
    invoke-virtual {p3, p1, p2}, Landroid/support/constraint/motion/utils/HyperSpline$Cubic;->eval(D)D
...
.method public getPos(D[D)V
    ...
    .line 90
    :goto_0
    iget-object p2, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mCurveLength:[D
    ...
    .line 94
    iget-object p2, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mCurve:[[Landroid/support/constraint/motion/utils/HyperSpline$Cubic;

    aget-object p2, p2, v0

    aget-object p2, p2, p1

    iget-object v3, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mCurveLength:[D

    aget-wide v4, v3, p1

    div-double v3, v1, v4

    invoke-virtual {p2, v3, v4}, Landroid/support/constraint/motion/utils/HyperSpline$Cubic;->eval(D)D
...
.method public getVelocity(D[D)V
    ...
    invoke-virtual {p2, v3, v4}, Landroid/support/constraint/motion/utils/HyperSpline$Cubic;->vel(D)D
...
.method public setup([[D)V
    ...
    iput v1, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mPoints:I
    ...
    iput-object v1, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mCtl:[[D

    .line 50
    iget v1, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mDimensionality:I

    new-array v1, v1, [[Landroid/support/constraint/motion/utils/HyperSpline$Cubic;
    ...
    .line 51
    :goto_0
    iget v2, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mDimensionality:I
    ...
    .line 52
    :goto_1
    iget v3, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mPoints:I

    if-ge v2, v3, :cond_0

    .line 53
    iget-object v3, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mCtl:[[D
    ...
    .line 61
    :cond_2
    iget p1, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mPoints:I

    add-int/lit8 p1, p1, -0x1

    new-array p1, p1, [D

    iput-object p1, p0, Landroid/support/constraint/motion/utils/HyperSpline;->mCurveLength:[D
    ...
    invoke-virtual {p0, p1}, Landroid/support/constraint/motion/utils/HyperSpline;->approxLength([Landroid/support/constraint/motion/utils/HyperSpline$Cubic;)D
