...
.method public constructor <init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 195
    sget-object v0, Landroid/support/constraint/R$styleable;->Variant:[I
    ...
    iput v2, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mConstraintID:I
    ...
    iget v4, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mConstraintID:I
    ...
    .line 224
    iget v3, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMaxHeight:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMaxHeight:F
    ...
    .line 226
    iget v3, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMinHeight:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMinHeight:F
    ...
    .line 228
    iget v3, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMaxWidth:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMaxWidth:F
    ...
    .line 230
    iget v3, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMinWidth:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMinWidth:F
...
.method match(FF)Z
    ...
    .line 267
    :cond_2
    iget p1, p0, Landroid/support/constraint/ConstraintLayoutStates$Variant;->mMaxHeight:F
