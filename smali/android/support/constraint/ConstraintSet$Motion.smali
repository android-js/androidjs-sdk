...
.method static constructor <clinit>()V
    ...
    sget v1, Landroid/support/constraint/R$styleable;->Motion_motionStagger:I
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/support/constraint/ConstraintSet$Motion;->mMotionStagger:F
...
.method public copyFrom(Landroid/support/constraint/ConstraintSet$Motion;)V
    .locals 1
    .param p1, "src"    # Landroid/support/constraint/ConstraintSet$Motion;

    .line 1189
    iget-boolean v0, p1, Landroid/support/constraint/ConstraintSet$Motion;->mApply:Z
    ...
    .line 1194
    iget v0, p1, Landroid/support/constraint/ConstraintSet$Motion;->mPathRotate:F

    iput v0, p0, Landroid/support/constraint/ConstraintSet$Motion;->mPathRotate:F

    .line 1195
    iget v0, p1, Landroid/support/constraint/ConstraintSet$Motion;->mMotionStagger:F
...
.method fillFromAttributeList(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v1, p0, Landroid/support/constraint/ConstraintSet$Motion;->mApply:Z
    ...
    .line 1222
    .local v3, "attr":I
    sget-object v4, Landroid/support/constraint/ConstraintSet$Motion;->mapToConstant:Landroid/util/SparseIntArray;
    ...
    .line 1244
    :pswitch_0
    iget v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mMotionStagger:F

    invoke-virtual {v0, v3, v4}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v4

    iput v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mMotionStagger:F

    goto :goto_1

    .line 1241
    :pswitch_1
    iget v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mAnimateRelativeTo:I

    invoke-static {v0, v3, v4}, Landroid/support/constraint/ConstraintSet;->access$100(Landroid/content/res/TypedArray;II)I

    move-result v4

    iput v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mAnimateRelativeTo:I
    ...
    iput v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mDrawPath:I
    ...
    iput-object v5, p0, Landroid/support/constraint/ConstraintSet$Motion;->mTransitionEasing:Ljava/lang/String;

    goto :goto_1

    .line 1234
    :cond_0
    sget-object v6, Landroid/support/constraint/motion/utils/Easing;->NAMED_EASING:[Ljava/lang/String;
    ...
    :pswitch_4
    iget v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mPathMotionArc:I

    invoke-virtual {v0, v3, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    iput v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mPathMotionArc:I
    ...
    .line 1224
    :pswitch_5
    iget v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mPathRotate:F

    invoke-virtual {v0, v3, v4}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v4

    iput v4, p0, Landroid/support/constraint/ConstraintSet$Motion;->mPathRotate:F
