...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p3, p0, Landroid/support/constraint/utils/MockView;->mPaintDiagonals:Landroid/graphics/Paint;
    ...
    iput-object p3, p0, Landroid/support/constraint/utils/MockView;->mPaintText:Landroid/graphics/Paint;
    ...
    iput-object p3, p0, Landroid/support/constraint/utils/MockView;->mPaintTextBackground:Landroid/graphics/Paint;

    const/4 p3, 0x1

    .line 26
    iput-boolean p3, p0, Landroid/support/constraint/utils/MockView;->mDrawDiagonals:Z

    .line 27
    iput-boolean p3, p0, Landroid/support/constraint/utils/MockView;->mDrawLabel:Z

    const/4 p3, 0x0

    .line 28
    iput-object p3, p0, Landroid/support/constraint/utils/MockView;->mText:Ljava/lang/String;
    ...
    iput p3, p0, Landroid/support/constraint/utils/MockView;->mTextBackgroundColor:I

    const/4 p3, 0x4

    .line 33
    iput p3, p0, Landroid/support/constraint/utils/MockView;->mMargin:I
...
.method private init(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 56
    sget v3, Landroid/support/constraint/R$styleable;->MockView_mock_label:I
    ...
    iput-object v2, p0, Landroid/support/constraint/utils/MockView;->mText:Ljava/lang/String;

    goto :goto_1

    .line 58
    :cond_0
    sget v3, Landroid/support/constraint/R$styleable;->MockView_mock_showDiagonals:I

    if-ne v2, v3, :cond_1

    .line 59
    iget-boolean v3, p0, Landroid/support/constraint/utils/MockView;->mDrawDiagonals:Z

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Landroid/support/constraint/utils/MockView;->mDrawDiagonals:Z

    goto :goto_1

    .line 60
    :cond_1
    sget v3, Landroid/support/constraint/R$styleable;->MockView_mock_diagonalsColor:I

    if-ne v2, v3, :cond_2

    .line 61
    iget v3, p0, Landroid/support/constraint/utils/MockView;->mDiagonalsColor:I
    ...
    .line 62
    :cond_2
    sget v3, Landroid/support/constraint/R$styleable;->MockView_mock_labelBackgroundColor:I

    if-ne v2, v3, :cond_3

    .line 63
    iget v3, p0, Landroid/support/constraint/utils/MockView;->mTextBackgroundColor:I

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v2

    iput v2, p0, Landroid/support/constraint/utils/MockView;->mTextBackgroundColor:I

    goto :goto_1

    .line 64
    :cond_3
    sget v3, Landroid/support/constraint/R$styleable;->MockView_mock_labelColor:I

    if-ne v2, v3, :cond_4

    .line 65
    iget v3, p0, Landroid/support/constraint/utils/MockView;->mTextColor:I
    ...
    .line 66
    :cond_4
    sget v3, Landroid/support/constraint/R$styleable;->MockView_mock_showLabel:I
    ...
    iput-boolean v2, p0, Landroid/support/constraint/utils/MockView;->mDrawLabel:Z
    ...
    .line 71
    :cond_6
    iget-object p2, p0, Landroid/support/constraint/utils/MockView;->mText:Ljava/lang/String;
    ...
    iput-object p1, p0, Landroid/support/constraint/utils/MockView;->mText:Ljava/lang/String;
    :try_end_0
    ...
    :catch_0
    :cond_7
    iget-object p1, p0, Landroid/support/constraint/utils/MockView;->mPaintDiagonals:Landroid/graphics/Paint;

    iget p2, p0, Landroid/support/constraint/utils/MockView;->mDiagonalsColor:I
    ...
    .line 79
    iget-object p1, p0, Landroid/support/constraint/utils/MockView;->mPaintText:Landroid/graphics/Paint;

    iget v0, p0, Landroid/support/constraint/utils/MockView;->mTextColor:I
    ...
    .line 81
    iget-object p1, p0, Landroid/support/constraint/utils/MockView;->mPaintTextBackground:Landroid/graphics/Paint;

    iget p2, p0, Landroid/support/constraint/utils/MockView;->mTextBackgroundColor:I

    invoke-virtual {p1, p2}, Landroid/graphics/Paint;->setColor(I)V

    .line 82
    iget p1, p0, Landroid/support/constraint/utils/MockView;->mMargin:I
    ...
    iput p1, p0, Landroid/support/constraint/utils/MockView;->mMargin:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 94
    iget-object v10, p0, Landroid/support/constraint/utils/MockView;->mPaintDiagonals:Landroid/graphics/Paint;
    ...
    iget v4, p0, Landroid/support/constraint/utils/MockView;->mMargin:I
    ...
    iget v5, p0, Landroid/support/constraint/utils/MockView;->mMargin:I

    sub-int/2addr v4, v5

    iget-object v5, p0, Landroid/support/constraint/utils/MockView;->mTextBounds:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Landroid/support/constraint/utils/MockView;->mPaintTextBackground:Landroid/graphics/Paint;
