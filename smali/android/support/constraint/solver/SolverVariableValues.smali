...
.method private addToHashMap(Landroid/support/constraint/solver/SolverVariable;I)V
    ...
    iget v0, p0, Landroid/support/constraint/solver/SolverVariableValues;->HASH_SIZE:I

    rem-int/2addr p1, v0

    .line 217
    iget-object v0, p0, Landroid/support/constraint/solver/SolverVariableValues;->keys:[I
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, Landroid/support/constraint/solver/SolverVariableValues;->nextKeys:[I
...
.method private addVariable(ILandroid/support/constraint/solver/SolverVariable;F)V
    ...
    .line 292
    iget-object p3, p0, Landroid/support/constraint/solver/SolverVariableValues;->next:[I

    aput v0, p3, p1

    .line 293
    iget-object p1, p0, Landroid/support/constraint/solver/SolverVariableValues;->mRow:Landroid/support/constraint/solver/ArrayRow;

    invoke-virtual {p2, p1}, Landroid/support/constraint/solver/SolverVariable;->addToRow(Landroid/support/constraint/solver/ArrayRow;)V

    .line 294
    iget p1, p2, Landroid/support/constraint/solver/SolverVariable;->usageInRowCount:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p2, Landroid/support/constraint/solver/SolverVariable;->usageInRowCount:I

    .line 295
    iget p1, p0, Landroid/support/constraint/solver/SolverVariableValues;->mCount:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Landroid/support/constraint/solver/SolverVariableValues;->mCount:I
...
.method private insertVariable(ILandroid/support/constraint/solver/SolverVariable;F)V
    ...
    .line 315
    :cond_0
    iget-object p1, p0, Landroid/support/constraint/solver/SolverVariableValues;->previous:[I
...
.method private removeFromHashMap(Landroid/support/constraint/solver/SolverVariable;)V
    ...
    .line 271
    iget-object p1, p0, Landroid/support/constraint/solver/SolverVariableValues;->keys:[I
...
.method public clear()V
    ...
    .line 184
    iget-object v4, p0, Landroid/support/constraint/solver/SolverVariableValues;->mRow:Landroid/support/constraint/solver/ArrayRow;
...
.method public getVariable(I)Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 66
    iget-object p1, p0, Landroid/support/constraint/solver/SolverVariableValues;->mCache:Landroid/support/constraint/solver/Cache;
...
.method public getVariableValue(I)F
    ...
    .line 82
    iget-object p1, p0, Landroid/support/constraint/solver/SolverVariableValues;->values:[F
...
.method public put(Landroid/support/constraint/solver/SolverVariable;F)V
    ...
    .line 339
    invoke-direct {p0, v1, p1, p2}, Landroid/support/constraint/solver/SolverVariableValues;->addVariable(ILandroid/support/constraint/solver/SolverVariable;F)V

    .line 340
    invoke-direct {p0, p1, v1}, Landroid/support/constraint/solver/SolverVariableValues;->addToHashMap(Landroid/support/constraint/solver/SolverVariable;I)V
...
.method public remove(Landroid/support/constraint/solver/SolverVariable;Z)F
    ...
    .line 400
    iget-object p2, p0, Landroid/support/constraint/solver/SolverVariableValues;->mRow:Landroid/support/constraint/solver/ArrayRow;
...
.method public toString()Ljava/lang/String;
    ...
    .line 158
    iget-object v4, p0, Landroid/support/constraint/solver/SolverVariableValues;->previous:[I
    ...
    iget-object v0, p0, Landroid/support/constraint/solver/SolverVariableValues;->mCache:Landroid/support/constraint/solver/Cache;
    ...
    iget-object v8, p0, Landroid/support/constraint/solver/SolverVariableValues;->previous:[I
...
.method public use(Landroid/support/constraint/solver/ArrayRow;Z)F
    ...
    .line 439
    iget-object p1, p1, Landroid/support/constraint/solver/ArrayRow;->variables:Landroid/support/constraint/solver/ArrayRow$ArrayRowVariables;

    check-cast p1, Landroid/support/constraint/solver/SolverVariableValues;

    .line 440
    invoke-virtual {p1}, Landroid/support/constraint/solver/SolverVariableValues;->getCurrentSize()I

    move-result v1

    .line 441
    iget v2, p1, Landroid/support/constraint/solver/SolverVariableValues;->head:I
    ...
    .line 455
    iget-object v4, p1, Landroid/support/constraint/solver/SolverVariableValues;->variables:[I
    ...
    .line 456
    iget-object v4, p1, Landroid/support/constraint/solver/SolverVariableValues;->values:[F

    aget v4, v4, v3

    .line 457
    iget-object v5, p0, Landroid/support/constraint/solver/SolverVariableValues;->mCache:Landroid/support/constraint/solver/Cache;
    ...
    iget-object v6, p1, Landroid/support/constraint/solver/SolverVariableValues;->variables:[I
    ...
    .line 458
    invoke-virtual {p0, v5, v4, p2}, Landroid/support/constraint/solver/SolverVariableValues;->add(Landroid/support/constraint/solver/SolverVariable;FZ)V
