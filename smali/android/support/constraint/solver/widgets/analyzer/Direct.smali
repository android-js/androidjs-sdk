...
.method private static canMeasure(Landroid/support/constraint/solver/widgets/ConstraintWidget;)Z
    ...
    .line 663
    invoke-virtual {p0, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->hasDanglingDimension(I)Z
...
.method private static horizontalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
    ...
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isMeasureRequested()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->canMeasure(Landroid/support/constraint/solver/widgets/ConstraintWidget;)Z
    ...
    .line 232
    invoke-static {p0, p1, v0, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->measure(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;Z)Z
    ...
    .line 237
    invoke-virtual {v0}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->getFinalValue()I
    ...
    .line 242
    iget-object v9, v5, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->mOwner:Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 247
    new-instance v11, Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;

    invoke-direct {v11}, Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;-><init>()V

    .line 248
    invoke-static {v9, p1, v11, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->measure(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;Z)Z
    ...
    invoke-virtual {v10}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->hasFinalValue()Z
    ...
    iget-object v5, v9, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mLeft:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 281
    invoke-virtual {v5}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->hasFinalValue()Z
    ...
    .line 263
    invoke-virtual {v9, v5, v10}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V

    .line 264
    invoke-static {v9, p1}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->horizontalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
    ...
    .line 266
    iget-object v5, v9, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mRight:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 268
    invoke-virtual {v9, v10, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V
    ...
    .line 272
    invoke-static {p1, v9}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveHorizontalCenterConstraints(Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 294
    invoke-static {v3}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->canMeasure(Landroid/support/constraint/solver/widgets/ConstraintWidget;)Z

    move-result v5

    .line 295
    invoke-virtual {v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isMeasureRequested()Z
    ...
    .line 296
    new-instance v9, Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;

    invoke-direct {v9}, Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;-><init>()V

    .line 297
    invoke-static {v3, p1, v9, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->measure(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;Z)Z
    ...
    invoke-virtual {v9}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->hasFinalValue()Z
    ...
    .line 328
    :cond_14
    invoke-virtual {v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isInHorizontalChain()Z

    move-result v2

    if-nez v2, :cond_e

    invoke-virtual {v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isInVirtualLayout()Z
    ...
    .line 330
    invoke-static {p0, p1, v3}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveHorizontalMatchConstraint(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 314
    iget-object v2, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mLeft:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 316
    invoke-virtual {v3, v2, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V

    .line 317
    invoke-static {v3, p1}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->horizontalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
    ...
    .line 319
    iget-object v2, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mRight:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 321
    invoke-virtual {v3, v5, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V
    ...
    .line 324
    invoke-static {p1, v3}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveHorizontalCenterConstraints(Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
...
.method public static solveChain(Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;Landroid/support/constraint/solver/LinearSystem;IILandroid/support/constraint/solver/widgets/ChainHead;ZZZ)Z
    ...
    .line 719
    iget-object v6, v1, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListAnchors:[Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual {v8}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->hasFinalValue()Z
    ...
    invoke-virtual {v6}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->getFinalValue()I
    ...
    .line 746
    iget-object v15, v12, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListAnchors:[Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 751
    :cond_7
    iget-object v15, v12, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListDimensionBehaviors:[Landroid/support/constraint/solver/widgets/ConstraintWidget$DimensionBehaviour;
    ...
    invoke-static {v12, v1, v9, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->measure(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;Z)Z
    ...
    .line 777
    iget-object v15, v1, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListAnchors:[Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual {v3, v0, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V
    ...
    invoke-virtual {v3, v0, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalVertical(II)V
    ...
    invoke-virtual {v3, v6, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V
    ...
    invoke-virtual {v4, v0, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V
    ...
    invoke-virtual {v3, v6, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalVertical(II)V
    ...
    invoke-virtual {v4, v0, v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalVertical(II)V
...
.method private static solveHorizontalCenterConstraints(Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    invoke-virtual {v6}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->isRtl()Z
    ...
    .line 518
    :cond_3
    invoke-virtual {p1, v0, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V
...
.method private static solveHorizontalMatchConstraint(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 574
    instance-of v3, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;
    ...
    .line 580
    :cond_1
    iget p0, p2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintDefaultWidth:I
    ...
    :cond_2
    :goto_1
    iget p0, p2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintMinWidth:I
    ...
    .line 584
    iget p0, p2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintMaxWidth:I
    ...
    .line 592
    invoke-virtual {p2, v1, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalHorizontal(II)V
...
.method private static solveVerticalCenterConstraints(Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 553
    :cond_2
    invoke-virtual {p1, v4, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalVertical(II)V
...
.method private static solveVerticalMatchConstraint(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 620
    :cond_1
    iget p0, p2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintDefaultHeight:I
    ...
    :cond_2
    :goto_1
    iget p0, p2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintMinHeight:I
    ...
    .line 624
    iget p0, p2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintMaxHeight:I
    ...
    .line 632
    invoke-virtual {p2, v1, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalVertical(II)V
...
.method public static solvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
    ...
    .line 59
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->resetFinalResolution()V

    .line 60
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->getChildren()Ljava/util/ArrayList;
    ...
    .line 64
    invoke-virtual {v6}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->resetFinalResolution()V
    ...
    invoke-virtual {p0, v4, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->setFinalHorizontal(II)V
    ...
    .line 84
    check-cast v10, Landroid/support/constraint/solver/widgets/Guideline;

    .line 85
    invoke-virtual {v10}, Landroid/support/constraint/solver/widgets/Guideline;->getOrientation()I
    ...
    .line 86
    invoke-virtual {v10}, Landroid/support/constraint/solver/widgets/Guideline;->getRelativeBegin()I
    ...
    invoke-virtual {v10, v5}, Landroid/support/constraint/solver/widgets/Guideline;->setFinalValue(I)V
    ...
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->isResolvedHorizontally()Z
    ...
    .line 96
    :cond_5
    instance-of v7, v10, Landroid/support/constraint/solver/widgets/Barrier;
    ...
    .line 106
    instance-of v10, v5, Landroid/support/constraint/solver/widgets/Guideline;
    ...
    .line 108
    invoke-virtual {v5}, Landroid/support/constraint/solver/widgets/Guideline;->getOrientation()I
    ...
    .line 109
    invoke-static {v5, p1}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->horizontalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
    ...
    .line 122
    instance-of v6, v5, Landroid/support/constraint/solver/widgets/Barrier;

    if-eqz v6, :cond_a

    .line 123
    check-cast v5, Landroid/support/constraint/solver/widgets/Barrier;

    .line 124
    invoke-virtual {v5}, Landroid/support/constraint/solver/widgets/Barrier;->getOrientation()I
    ...
    .line 125
    invoke-static {v5, p1, v4}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveBarrier(Landroid/support/constraint/solver/widgets/Barrier;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;I)V
    ...
    invoke-virtual {p0, v4, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->setFinalVertical(II)V
    ...
    .line 143
    instance-of v10, v6, Landroid/support/constraint/solver/widgets/Guideline;
    ...
    invoke-virtual {v6, v1}, Landroid/support/constraint/solver/widgets/Guideline;->setFinalValue(I)V
    ...
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->isResolvedVertically()Z
    ...
    .line 156
    :cond_10
    instance-of v10, v6, Landroid/support/constraint/solver/widgets/Barrier;

    if-eqz v10, :cond_11

    .line 157
    check-cast v6, Landroid/support/constraint/solver/widgets/Barrier;

    .line 158
    invoke-virtual {v6}, Landroid/support/constraint/solver/widgets/Barrier;->getOrientation()I
    ...
    .line 166
    instance-of v6, v1, Landroid/support/constraint/solver/widgets/Guideline;
    ...
    .line 169
    invoke-static {v1, p1}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->verticalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
    ...
    .line 182
    instance-of v1, v0, Landroid/support/constraint/solver/widgets/Barrier;
    ...
    .line 184
    invoke-virtual {v0}, Landroid/support/constraint/solver/widgets/Barrier;->getOrientation()I
    ...
    .line 185
    invoke-static {v0, p1, v9}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveBarrier(Landroid/support/constraint/solver/widgets/Barrier;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;I)V
    ...
    .line 194
    invoke-virtual {v0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isMeasureRequested()Z

    move-result v1

    if-eqz v1, :cond_17

    invoke-static {v0}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->canMeasure(Landroid/support/constraint/solver/widgets/ConstraintWidget;)Z
    ...
    .line 195
    sget-object v1, Landroid/support/constraint/solver/widgets/analyzer/Direct;->measure:Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;

    invoke-static {v0, p1, v1, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->measure(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;Z)Z

    .line 196
    invoke-static {v0, p1}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->horizontalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V

    .line 197
    invoke-static {v0, p1}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->verticalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
...
.method private static verticalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
    ...
    iget-object v5, v9, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mTop:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 402
    invoke-static {p0, p1, v9}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveVerticalMatchConstraint(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 382
    invoke-virtual {v9, v5, v10}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalVertical(II)V

    .line 383
    invoke-static {v9, p1}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->verticalSolvingPass(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;)V
    ...
    .line 387
    invoke-virtual {v9, v10, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalVertical(II)V
    ...
    .line 391
    invoke-static {p1, v9}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveVerticalCenterConstraints(Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 421
    :cond_f
    iget-object v9, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mTop:Landroid/support/constraint/solver/widgets/ConstraintAnchor;

    if-ne v2, v9, :cond_10

    iget-object v9, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mBottom:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 447
    :cond_14
    invoke-virtual {v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isInVerticalChain()Z
    ...
    .line 449
    invoke-static {p0, p1, v3}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveVerticalMatchConstraint(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 433
    iget-object v2, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mTop:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 435
    invoke-virtual {v3, v2, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalVertical(II)V
    ...
    .line 438
    iget-object v2, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mBottom:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 443
    invoke-static {p1, v3}, Landroid/support/constraint/solver/widgets/analyzer/Direct;->solveVerticalCenterConstraints(Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 456
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->getDependents()Ljava/util/HashSet;

    move-result-object v0

    if-eqz v0, :cond_1e

    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->hasFinalValue()Z
    ...
    .line 457
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->getFinalValue()I
    ...
    .line 462
    new-instance v5, Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;

    invoke-direct {v5}, Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;-><init>()V

    .line 463
    invoke-static {v3, p1, v5, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->measure(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measurer;Landroid/support/constraint/solver/widgets/analyzer/BasicMeasure$Measure;Z)Z
    ...
    .line 475
    invoke-virtual {v3, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setFinalBaseline(I)V
