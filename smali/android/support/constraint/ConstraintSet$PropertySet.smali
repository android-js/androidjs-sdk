...
.method public copyFrom(Landroid/support/constraint/ConstraintSet$PropertySet;)V
    ...
    iput p1, p0, Landroid/support/constraint/ConstraintSet$PropertySet;->mVisibilityMode:I
...
.method fillFromAttributeList(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1161
    sget v2, Landroid/support/constraint/R$styleable;->PropertySet_android_alpha:I
    ...
    .line 1163
    :cond_0
    sget v2, Landroid/support/constraint/R$styleable;->PropertySet_android_visibility:I
    ...
    .line 1166
    :cond_1
    sget v2, Landroid/support/constraint/R$styleable;->PropertySet_visibilityMode:I

    if-ne v1, v2, :cond_2

    .line 1167
    iget v2, p0, Landroid/support/constraint/ConstraintSet$PropertySet;->mVisibilityMode:I

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, p0, Landroid/support/constraint/ConstraintSet$PropertySet;->mVisibilityMode:I

    goto :goto_1

    .line 1168
    :cond_2
    sget v2, Landroid/support/constraint/R$styleable;->PropertySet_motionProgress:I
